...
//        gw.setCumulativeBombardment(false);
        ...
        // Golan I
        SpaceshipType tempsst = new SpaceshipType("Defence Platform I", "DPI", SpaceShipSize.SMALL, 10, 30, SpaceshipRange.NONE, 1, 3, 10);
        tempsst.setDescription("Small non-mobile defence unit");
        gw.addShipType(tempsst);
        // Golan II
        tempsst = new SpaceshipType("Defence Platform II", "DPII", SpaceShipSize.MEDIUM, 30, 80, SpaceshipRange.NONE, 1, 6, 30);
        tempsst.setDescription("Medium non-mobile defence unit");
        tempsst.setArmorSmall(0);
        gw.addShipType(tempsst);
        // Golan III
        tempsst = new SpaceshipType("Defence Platform III", "DPIII", SpaceShipSize.LARGE, 50, 140, SpaceshipRange.NONE, 1, 9, 50);
        tempsst.setDescription("Large non-mobile defence unit");
        tempsst.setArmorSmall(0);
        tempsst.setArmorMedium(0);
        gw.addShipType(tempsst);
        // Corvette
        tempsst = new SpaceshipType("Corvette", "Crv", SpaceShipSize.SMALL, 10, 20, SpaceshipRange.LONG, 1, 3, 10);
        ...
        gw.addShipType(tempsst);
        // Destroyer
        tempsst = new SpaceshipType("Destroyer", "Des", SpaceShipSize.MEDIUM, 40, 80, SpaceshipRange.LONG, 3, 10, 30);
        tempsst.setDescription("Useful for long range raiding attacks, and also boost larger task forces");
        tempsst.setArmorSmall(0);
        tempsst.setPsychWarfare(1);
        gw.addShipType(tempsst);
        // Cruiser
        tempsst = new SpaceshipType("Cruiser", "Cru", SpaceShipSize.LARGE, 80, 300, SpaceshipRange.SHORT, 5, 16, 60);
        ...
        gw.addShipType(tempsst);
        // Battleship
        tempsst = new SpaceshipType("Battleship", "Bat", SpaceShipSize.HUGE, 120, 600, SpaceshipRange.SHORT, 10, 30, 120);
...
*/
        ...
        // orbital wharfs
        BuildingType smallOrbitalWharf = new BuildingType("Small Orbital Wharf", "W1", 5);
        smallOrbitalWharf.setWharfSize(1);
        smallOrbitalWharf.setInOrbit(true);
        BuildingType parent = smallOrbitalWharf;
        tempBuildings.add(smallOrbitalWharf);
        ...
        tempFaction.addStartingShipType(SpaceshipPureFunctions.getSpaceshipTypeByName("Corvette", gw));
        tempFaction.addStartingShipType(SpaceshipPureFunctions.getSpaceshipTypeByName("Destroyer", gw));
        tempFaction.addStartingShipType(SpaceshipPureFunctions.getSpaceshipTypeByName("Defence Platform II", gw));
