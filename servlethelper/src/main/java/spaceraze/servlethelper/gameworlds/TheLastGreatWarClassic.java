...
//������ vip types ������
   /*     VIPType tmpVipType = new VIPType("Governor","Gov",uniqueVIPIdCounter);
     ...
     */
        ...
        VIPType tmpVipType = new VIPType("Spy", "Spy", neutral);
...
//  ######## Neural ########
        ...
        SpaceshipType tempsst = new SpaceshipType("Medium Defender", "MDef", SpaceShipSize.MEDIUM, 40, 140, SpaceshipRange.NONE, 2, 10, 17, 15);
        ...
        tempsst = new SpaceshipType("Large Defender", "LDef", SpaceShipSize.LARGE, 75, 370, SpaceshipRange.NONE, 3, 36, 10, 10);
        tempsst.setTargetingType(SpaceshipTargetingType.ALLROUND);
        ...
        // ---------
        // Freedom Fighter
        tempsst = new SpaceshipType("Freedom Fighter", "FreF", SpaceShipSize.SMALL, 5, 40, SpaceshipRange.NONE, 1, 8, 12, 12);
...
//  ######## China (Red) ########
        ...
        // -----------------
        // China Defender
        tempsst = new SpaceshipType("China Defender", "CDef", SpaceShipSize.MEDIUM, 10, 60, SpaceshipRange.NONE, 1, 8, 8, 40);
        ...
        // China Home Base
        tempsst = new SpaceshipType("China Home Base", "CHom", SpaceShipSize.LARGE, 20, 350, SpaceshipRange.NONE, 0, 200, 10, 20);
        tempsst.setTargetingType(SpaceshipTargetingType.ANTIAIR);
        ...
        // ---------
        // China Fighter
        tempsst = new SpaceshipType("China Fighter", "CFig", SpaceShipSize.SMALL, 0, 18, SpaceshipRange.NONE, 1, 2, 5, 10);
        tempsst.setSquadron(true);
        tempsst.setTargetingType(SpaceshipTargetingType.ANTIAIR);
        tempsst.setCanAppearOnBlackMarket(false);
        ...
        */
        // China Bomber
        tempsst = new SpaceshipType("China Bomber", "CBom", SpaceShipSize.SMALL, 0, 15, SpaceshipRange.NONE, 1, 2, 10, 3);
        tempsst.setSquadron(true);
        ...
        */
        ...
        //WarBattleship
        tempsst = new SpaceshipType("WarBattleship", "WarB", SpaceShipSize.LARGE, 90, 550, SpaceshipRange.SHORT, 18, 68, 15, 12);
        tempsst.setTargetingType(SpaceshipTargetingType.ANTIMBU);
...
//      Galaxy WarBattleship
        ...
        tmpVipType = new VIPType("Party Leader", "Par", china);
        tmpVipType.setGovernor(true);
        tmpVipType.setWellGuarded(true);
        tmpVipType.setOpenIncBonus(1);
        ...
        tmpVipType = new VIPType("Military Navigator", "MNav", china);
        tmpVipType.setCanVisitNeutralPlanets(true);
        tmpVipType.setCanVisitEnemyPlanets(true);
...
//      XXX Allians Of Africa
        ...
        // -----------------
        // Allians Defender
        tempsst = new SpaceshipType("Allians Defender", "ADef", SpaceShipSize.LARGE, 75, 370, SpaceshipRange.NONE, 4, 30, 5, 5);
        tempsst.setTargetingType(SpaceshipTargetingType.ANTIMBU);
        tempsst.setWeaponsStrengthMedium(20);
        ...
        // Allians Home Base
        tempsst = new SpaceshipType("Allians Home Base", "AHom", SpaceShipSize.LARGE, 20, 300, SpaceshipRange.NONE, 0, 200, 10, 10);
        tempsst.setTargetingType(SpaceshipTargetingType.ANTIMBU);
        tempsst.setArmorSmall(45);
        tempsst.setArmorMedium(20);
        ...
        // ---------
        // Allians Fighter
        tempsst = new SpaceshipType("Allians Fighter", "A-F", SpaceShipSize.SMALL, 7, 20, SpaceshipRange.NONE, 1, 3, 5, 17);
        tempsst.setSquadron(true);
        tempsst.setTargetingType(SpaceshipTargetingType.ANTIAIR);
        tempsst.setCanAppearOnBlackMarket(false);
        ...
        // Allians Bomber
        tempsst = new SpaceshipType("Allians Bomber", "A-B", SpaceShipSize.SMALL, 7, 15, SpaceshipRange.NONE, 1, 3, 15, 3);
        tempsst.setSquadron(true);
        tempsst.setTargetingType(SpaceshipTargetingType.ANTIMBU);
        ...
        //Allians Attacker
        tempsst = new SpaceshipType("Allians Attacker", "A-A", SpaceShipSize.SMALL, 7, 30, SpaceshipRange.NONE, 2, 4, 8, 11);
        tempsst.setTargetingType(SpaceshipTargetingType.ALLROUND);
        tempsst.setSquadron(true);
        ...
        //Assault Attacker
        tempsst = new SpaceshipType("Assault Attacker", "AAtt", SpaceShipSize.MEDIUM, 10, 50, SpaceshipRange.LONG, 3, 14, 12, 24);
        tempsst.setTargetingType(SpaceshipTargetingType.ALLROUND);
        tempsst.setSquadron(true);
        ...
        tmpVipType = new VIPType("Top Pilot", "TopP", alliance);
        tmpVipType.setCanVisitNeutralPlanets(true);
        tmpVipType.setCanVisitEnemyPlanets(true);
        tmpVipType.setHardToKill(true);
...
//      XXX Trade Federation        
        ...
        // -----------------
        // Federation Defender
        tempsst = new SpaceshipType("Federation Defender", "FDef", SpaceShipSize.LARGE, 75, 370, SpaceshipRange.NONE, 4, 36, 10, 10);
        tempsst.setTargetingType(SpaceshipTargetingType.ANTIMBU);
        tempsst.setWeaponsStrengthMedium(25);
        tempsst.setWeaponsMaxSalvoesMedium(15);
        ...
        tempsst = new SpaceshipType("Federation Home Base", "FHom", SpaceShipSize.HUGE, 20, 600, SpaceshipRange.NONE, 0, 200, 10, 10);
        tempsst.setTargetingType(SpaceshipTargetingType.ANTIMBU);
        tempsst.setArmorSmall(45);
        tempsst.setArmorMedium(20);
        ...
        // ---------
        // Federation Fighter
        tempsst = new SpaceshipType("Federation Fighter", "F-F", SpaceShipSize.SMALL, 0, 22, SpaceshipRange.NONE, 1, 2, 5, 13);
        tempsst.setSquadron(true);
        tempsst.setTargetingType(SpaceshipTargetingType.ANTIAIR);
        tempsst.setCanAppearOnBlackMarket(false);
        ...
        // Federation Bomber
        tempsst = new SpaceshipType("Federation Bomber", "F-B", SpaceShipSize.SMALL, 0, 15, SpaceshipRange.NONE, 1, 2, 10, 3);
        tempsst.setSquadron(true);
        tempsst.setTargetingType(SpaceshipTargetingType.ANTIMBU);
        ...
        // Federation Attacker
        tempsst = new SpaceshipType("Federation Attacker", "F-A", SpaceShipSize.SMALL, 0, 30, SpaceshipRange.SHORT, 2, 4, 5, 8);
        tempsst.setTargetingType(SpaceshipTargetingType.ALLROUND);
        tempsst.setSquadron(true);
        tempsst.setWeaponsStrengthMedium(10);
        tempsst.setWeaponsMaxSalvoesMedium(4);
        ...
        // Frigate
        tempsst = new SpaceshipType("Frigate", "Frg", SpaceShipSize.SMALL, 10, 50, SpaceshipRange.LONG, 3, 7, 17, 8);
        tempsst.setTargetingType(SpaceshipTargetingType.ALLROUND);
        tempsst.setWeaponsStrengthMedium(5);
        tempsst.setWeaponsMaxSalvoesMedium(2);
        ...
        // Supply Frigate
        tempsst = new SpaceshipType("Supply Frigate", "SFri", SpaceShipSize.MEDIUM, 5, 30, SpaceshipRange.SHORT, 1, 10, 5, 5);
        tempsst.setTargetingType(SpaceshipTargetingType.ALLROUND);
        ...
        // Medium Destroyer
        tempsst = new SpaceshipType("Medium Destroyer", "MDes", SpaceShipSize.MEDIUM, 20, 110, SpaceshipRange.LONG, 5, 12, 15, 15);
        tempsst.setTargetingType(SpaceshipTargetingType.ANTIMBU);
        tempsst.setWeaponsStrengthMedium(15);
        tempsst.setWeaponsMaxSalvoesMedium(5);
        tempsst.setArmorSmall(40);
        ...
        //Battleship
        tempsst = new SpaceshipType("Battleship", "Bat", SpaceShipSize.LARGE, 75, 375, SpaceshipRange.SHORT, 11, 40, 10, 10);
        tempsst.setTargetingType(SpaceshipTargetingType.ANTIMBU);
        tempsst.setWeaponsStrengthMedium(30);
        tempsst.setWeaponsMaxSalvoesMedium(20);
...
//      Galaxy Battleship
        ...
        tmpVipType = new VIPType("Resistance Leader", "ResL", trade);
        tmpVipType.setCanVisitNeutralPlanets(true);
        tmpVipType.setCanVisitEnemyPlanets(true);
        tmpVipType.setHardToKill(true);
        tmpVipType.setWellGuarded(true);
...
//      XXX USA (Gul)        
        ...
        // USA Military Base
        tempsst = new SpaceshipType("USA Military Base", "UMB", SpaceShipSize.LARGE, 20, 300, SpaceshipRange.NONE, 0, 200, 10, 10);
        tempsst.setTargetingType(SpaceshipTargetingType.ANTIMBU);
        tempsst.setArmorSmall(45);
        tempsst.setArmorMedium(20);
        tempsst.setWeaponsStrengthMedium(10);
        ...
        // ---------
        // USA Fighter
        tempsst = new SpaceshipType("USA Fighter", "U-F", SpaceShipSize.SMALL, 0, 27, SpaceshipRange.NONE, 1, 2, 5, 14);
        tempsst.setSquadron(true);
        tempsst.setTargetingType(SpaceshipTargetingType.ANTIAIR);
        tempsst.setCanAppearOnBlackMarket(false);
        ...
        // USA Bomber
        tempsst = new SpaceshipType("USA Bomber", "U-B", SpaceShipSize.SMALL, 0, 18, SpaceshipRange.NONE, 1, 3, 15, 3);
        tempsst.setSquadron(true);
        tempsst.setTargetingType(SpaceshipTargetingType.ANTIMBU);
        tempsst.setWeaponsStrengthMedium(13);
        tempsst.setWeaponsMaxSalvoesMedium(4);
        ...
        // USA Attacker
        tempsst = new SpaceshipType("USA Attacker", "U-A", SpaceShipSize.SMALL, 7, 30, SpaceshipRange.SHORT, 2, 5, 8, 8);
        tempsst.setSquadron(true);
        tempsst.setTargetingType(SpaceshipTargetingType.ALLROUND);
        tempsst.setWeaponsStrengthMedium(12);
        tempsst.setWeaponsMaxSalvoesMedium(4);
        ...
        // Frigate II
        tempsst = new SpaceshipType("Frigate II", "Frg2", SpaceShipSize.SMALL, 15, 55, SpaceshipRange.LONG, 3, 7, 10, 5);
        tempsst.setArmorSmall(5);
        tempsst.setWeaponsStrengthMedium(5);
        tempsst.setWeaponsMaxSalvoesMedium(2);
        tempsst.setWeaponsStrengthLarge(10);
        ...
        // Carrier II
        tempsst = new SpaceshipType("Carrier II", "Car2", SpaceShipSize.MEDIUM, 15, 80, SpaceshipRange.LONG, 3, 14, 12, 12);
        tempsst.setTargetingType(SpaceshipTargetingType.ALLROUND);
        tempsst.setArmorSmall(35);
        tempsst.setSquadronCapacity(6);
        ...
        // Destroyer II
        tempsst = new SpaceshipType("Destroyer II", "Des2", SpaceShipSize.MEDIUM, 20, 130, SpaceshipRange.LONG, 5, 13, 20, 15);
        tempsst.setTargetingType(SpaceshipTargetingType.ANTIMBU);
        tempsst.setWeaponsStrengthMedium(15);
        tempsst.setWeaponsMaxSalvoesMedium(5);
        tempsst.setArmorSmall(40);
        ...
        //Battleship II
        tempsst = new SpaceshipType("Battleship II", "Bat2", SpaceShipSize.LARGE, 75, 440, SpaceshipRange.SHORT, 11, 49, 12, 12);
        tempsst.setTargetingType(SpaceshipTargetingType.ANTIMBU);
        tempsst.setWeaponsStrengthMedium(25);
        tempsst.setWeaponsMaxSalvoesMedium(20);
        tempsst.setWeaponsStrengthLarge(45);
...
//      Galaxy Battleship
        tempsst = new SpaceshipType("Galaxy Battleship II", "GBa2", SpaceShipSize.HUGE, 115, 750, SpaceshipRange.SHORT, 27, 96, 10, 10);
        tempsst.setTargetingType(SpaceshipTargetingType.ANTIMBU);
   ...
   /*     VIPType President2 = new VIPType("President","Pre",usa,uniqueVIPIdCounter);
        ...
        tmpVipType = new VIPType("Coordinator", "Coor", usa);
        tmpVipType.setCanVisitNeutralPlanets(true);
        tmpVipType.setCanVisitEnemyPlanets(true);
        tmpVipType.setHardToKill(true);
        tmpVipType.setWellGuarded(true);
...
//      XXX Russian (Rosa)        
        ...
        // Russian Home Base
        tempsst = new SpaceshipType("Russian Home Base", "RHom", SpaceShipSize.LARGE, 20, 300, SpaceshipRange.NONE, 0, 200, 10, 10);
        tempsst.setTargetingType(SpaceshipTargetingType.ANTIMBU);
        tempsst.setArmorSmall(45);
        tempsst.setArmorMedium(20);
        tempsst.setWeaponsStrengthMedium(10);
        ...
        // ---------
        // Russian Fighter
        tempsst = new SpaceshipType("Russian Fighter", "R-F", SpaceShipSize.SMALL, 0, 22, SpaceshipRange.NONE, 1, 2, 4, 12);
        tempsst.setSquadron(true);
        tempsst.setTargetingType(SpaceshipTargetingType.ANTIAIR);
        tempsst.setCanAppearOnBlackMarket(false);
        ...
        // Russian Bomber
        tempsst = new SpaceshipType("Russian Bomber", "R-B", SpaceShipSize.SMALL, 0, 15, SpaceshipRange.NONE, 1, 2, 10, 3);
        tempsst.setSquadron(true);
        tempsst.setTargetingType(SpaceshipTargetingType.ANTIMBU);
        tempsst.setWeaponsStrengthMedium(10);
        tempsst.setWeaponsMaxSalvoesMedium(4);
        ...
        tempsst = new SpaceshipType("Russian Heavy Bomber", "R-HB", SpaceShipSize.SMALL, 6, 30, SpaceshipRange.SHORT, 2, 6, 10, 2);
        tempsst.setTargetingType(SpaceshipTargetingType.ANTIMBU);
        tempsst.setSquadron(true);
        tempsst.setWeaponsStrengthMedium(17);
        tempsst.setWeaponsMaxSalvoesMedium(5);
        ...
        // -------------
        // Russian Corvette
        tempsst = new SpaceshipType("Russian Corvette", "RCrv", SpaceShipSize.SMALL, 6, 25, SpaceshipRange.LONG, 2, 3, 6, 5);
        tempsst.setTargetingType(SpaceshipTargetingType.ALLROUND);
        tempsst.setCanAppearOnBlackMarket(false);
        tempsst.setCanBlockPlanet(false);
        ...
        // Cruiser
        tempsst = new SpaceshipType("Cruiser", "Cru", SpaceShipSize.SMALL, 10, 50, SpaceshipRange.SHORT, 3, 5, 11, 8);
        tempsst.setTargetingType(SpaceshipTargetingType.ALLROUND);
        tempsst.setWeaponsStrengthMedium(5);
        tempsst.setWeaponsMaxSalvoesMedium(2);
        ...
        // Troop Cruiser
        tempsst = new SpaceshipType("Troop Cruiser", "TCru", SpaceShipSize.MEDIUM, 5, 20, SpaceshipRange.LONG, 2, 6, 8, 8);
        tempsst.setTargetingType(SpaceshipTargetingType.ALLROUND);
        tempsst.setArmorSmall(20);
        tempsst.setPsychWarfare(1);
        tempsst.setCanAppearOnBlackMarket(false);
        ...
        // planet Carrier
        tempsst = new SpaceshipType("Planet Carrier", "PCar", SpaceShipSize.MEDIUM, 6, 60, SpaceshipRange.LONG, 3, 9, 8, 8);
        tempsst.setTargetingType(SpaceshipTargetingType.ALLROUND);
        tempsst.setArmorSmall(20);
        ...
        // Ship Destroyer
        tempsst = new SpaceshipType("Ship Destroyer", "SDes", SpaceShipSize.MEDIUM, 10, 100, SpaceshipRange.LONG, 5, 9, 12, 10);
        tempsst.setTargetingType(SpaceshipTargetingType.ANTIMBU);
        tempsst.setWeaponsStrengthMedium(12);
        tempsst.setWeaponsMaxSalvoesMedium(6);
        ...
        //Star Destroyer
        tempsst = new SpaceshipType("Star Destroyer", "StaD", SpaceShipSize.LARGE, 45, 310, SpaceshipRange.SHORT, 11, 34, 10, 30);
        tempsst.setTargetingType(SpaceshipTargetingType.ALLROUND);
...
//      Galaxy Destroyer
        tempsst = new SpaceshipType("Galaxy Destroyer", "GDes", SpaceShipSize.HUGE, 80, 600, SpaceshipRange.SHORT, 25, 86, 10, 15);
        tempsst.setTargetingType(SpaceshipTargetingType.ANTIMBU);
        tempsst.setWeaponsStrengthMedium(25);
   ...
   /*     VIPType President3 = new VIPType("President","Pre",russian,uniqueVIPIdCounter);
        ...
        tmpVipType = new VIPType("Engineer", "Eng", russian);
        tmpVipType.setCanVisitNeutralPlanets(true);
        tmpVipType.setCanVisitEnemyPlanets(true);
        tmpVipType.setHardToKill(true);
        tmpVipType.setWellGuarded(true);
...
//      XXX EU (Turkos)       
        ...
        // EU Home Base
        tempsst = new SpaceshipType("EU Home Base", "EHom", SpaceShipSize.LARGE, 120, 20, SpaceshipRange.NONE, 0, 200, 10, 10);
        tempsst.setTargetingType(SpaceshipTargetingType.ANTIMBU);
        ...
        // ---------
        // EU Fighter
        tempsst = new SpaceshipType("EU Fighter", "EU-F", SpaceShipSize.SMALL, 13, 7, SpaceshipRange.NONE, 1, 3, 5, 19);
        tempsst.setSquadron(true);
        tempsst.setTargetingType(SpaceshipTargetingType.ANTIAIR);
        ...
        // EU Bomber
        tempsst = new SpaceshipType("EU Bomber", "EU-B", SpaceShipSize.SMALL, 7, 7, SpaceshipRange.NONE, 1, 2, 10, 3);
        tempsst.setSquadron(true);
        tempsst.setTargetingType(SpaceshipTargetingType.ANTIMBU);
        tempsst.setWeaponsStrengthMedium(12);
        tempsst.setWeaponsMaxSalvoesMedium(4);
        ...
        // EU Attacker
        tempsst = new SpaceshipType("EU Attacker", "EU-A", SpaceShipSize.SMALL, 15, 10, SpaceshipRange.LONG, 2, 5, 10, 10);
        tempsst.setTargetingType(SpaceshipTargetingType.ALLROUND);
        tempsst.setSquadron(true);
        tempsst.setWeaponsStrengthMedium(10);
        tempsst.setWeaponsMaxSalvoesMedium(4);
        ...
        //Star Frigate
        tempsst = new SpaceshipType("Star Frigate", "SFRi", SpaceShipSize.LARGE, 160, 250, SpaceshipRange.SHORT, 11, 41, 20, 10);
        tempsst.setTargetingType(SpaceshipTargetingType.ANTIMBU);
        tempsst.setWeaponsStrengthMedium(25);
        tempsst.setWeaponsMaxSalvoesMedium(20);
...
//      Galaxy Frigate
        tempsst = new SpaceshipType("Galaxy Frigate", "GFri", SpaceShipSize.LARGE, 270, 300, SpaceshipRange.LONG, 20, 66, 10, 25);
        tempsst.setTargetingType(SpaceshipTargetingType.ANTIMBU);
        tempsst.setWeaponsStrengthMedium(20);
        tempsst.setWeaponsMaxSalvoesMedium(12);
        tempsst.setWeaponsStrengthLarge(50);
    ...
    /*    VIPType President4 = new VIPType("President","Pre",eu,uniqueVIPIdCounter);
        ...
        tmpVipType = new VIPType("War Genius ", "WarG", eu);
        tmpVipType.setCanVisitNeutralPlanets(true);
        tmpVipType.setCanVisitEnemyPlanets(true);
        tmpVipType.setHardToKill(true);
        tmpVipType.setWellGuarded(true);
...
//      XXX Federation of liberty        
        ...
        // -----------------
        // Liberty Defender
        tempsst = new SpaceshipType("Liberty Defender", "LDef", SpaceShipSize.HUGE, 0, 540, SpaceshipRange.NONE, 5, 36, 15, 10);
        tempsst.setTargetingType(SpaceshipTargetingType.ANTIMBU);
        tempsst.setWeaponsStrengthMedium(25);
        tempsst.setWeaponsMaxSalvoesMedium(20);
        ...
        // Raid Station
        tempsst = new SpaceshipType("Raid Station", "RSta", SpaceShipSize.MEDIUM, 0, 200, SpaceshipRange.NONE, 0, 120, 10, 10);
        tempsst.setTargetingType(SpaceshipTargetingType.ANTIMBU);
        tempsst.setArmorSmall(65);
        tempsst.setArmorMedium(30);
        tempsst.setWeaponsStrengthMedium(10);
        ...
        // ---------
        // Scout
        tempsst = new SpaceshipType("Scout", "Sco", SpaceShipSize.SMALL, 0, 10, SpaceshipRange.NONE, 1, 2, 1, 9);
        tempsst.setSquadron(true);
        tempsst.setTargetingType(SpaceshipTargetingType.ANTIAIR);
        tempsst.setPlanetarySurvey(true);
        ...
        // Liberty Fighter
        tempsst = new SpaceshipType("Liberty Fighter", "L-F", SpaceShipSize.SMALL, 0, 30, SpaceshipRange.NONE, 1, 2, 3, 13);
        tempsst.setSquadron(true);
        tempsst.setArmorSmall(20);
        tempsst.setTargetingType(SpaceshipTargetingType.ANTIAIR);
        tempsst.setCanAppearOnBlackMarket(false);
        ...
        // Liberty Bomber
        tempsst = new SpaceshipType("Liberty Bomber", "L-B", SpaceShipSize.SMALL, 0, 22, SpaceshipRange.NONE, 1, 2, 10, 2);
        tempsst.setSquadron(true);
        tempsst.setArmorSmall(10);
        tempsst.setTargetingType(SpaceshipTargetingType.ANTIMBU);
        tempsst.setWeaponsStrengthMedium(8);
        ...
        // Liberty Attacker
        tempsst = new SpaceshipType("Liberty Heavy Attacker", "L-HA", SpaceShipSize.SMALL, 0, 45, SpaceshipRange.SHORT, 2, 6, 10, 12);
        tempsst.setTargetingType(SpaceshipTargetingType.ALLROUND);
        tempsst.setSquadron(true);
        tempsst.setArmorSmall(10);
        ...
        // Planet Raider
        tempsst = new SpaceshipType("Planet Raider", "PRai", SpaceShipSize.MEDIUM, 0, 70, SpaceshipRange.LONG, 5, 9, 17, 5);
        tempsst.setTargetingType(SpaceshipTargetingType.ANTIMBU);
...
//      Galaxy Ship
  ...
  /*      VIPType President5 = new VIPType("President","Pre",federation,uniqueVIPIdCounter);
        ...
        tmpVipType = new VIPType("Master Spy", "MSpy", federation);
        tmpVipType.setCanVisitNeutralPlanets(true);
        tmpVipType.setCanVisitEnemyPlanets(true);
        tmpVipType.setHardToKill(true);
        tmpVipType.setWellGuarded(true);
