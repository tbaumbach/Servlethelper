...
//		gw.setBattleSimDefaultShips2("[0]pb;[0]crv;[0]udes;[0]ulcr;[0]ucr;[0]ubcr;[0]vbss;[0]cbs;[0]u-f;[0]u-b");
		...
		klackon.addCanHaveVip(evil);
		klackon.addCanHaveVip(arachnid);
		arachnid.addCanHaveVip(evil);
		arachnid.addCanHaveVip(klackon);
		evil.addCanHaveVip(klackon);
		evil.addCanHaveVip(arachnid);
		neutral.addCanHaveVip(klackon);
        ...
        tmpVipType = new VIPType("BRINT Agent","BrtA",neutral);
        tmpVipType.setCanVisitEnemyPlanets(true);
        tmpVipType.setSpying(true);
        gw.addVipType(tmpVipType);

        tmpVipType = new VIPType("BRINT Captain","BrtC",neutral);
        ...
        tmpVipType = new VIPType("BRINT General","BrtG",neutral);
        ...
        tmpVipType = new VIPType("BOSS Agent","BosA",neutral);
        tmpVipType.setCounterEspionage(50);
        tmpVipType.setResistanceBonus(3);
        tmpVipType.setExterminator(60);
        gw.addVipType(tmpVipType);

        tmpVipType = new VIPType("BOSS Captain","BosC",neutral);
        tmpVipType.setFrequency(BlackMarketFrequency.UNCOMMON);
        tmpVipType.setCounterEspionage(70);
        ...
        tmpVipType = new VIPType("BOSS General","BosG",neutral);
        tmpVipType.setFrequency(BlackMarketFrequency.RARE);
        ...
        tmpVipType = new VIPType("Assassin","Ass",evil);
        tmpVipType.setCanVisitEnemyPlanets(true);
        tmpVipType.setAssassination(50);
        gw.addVipType(tmpVipType);

        tmpVipType = new VIPType("Master Assassin","MAss",evil);
        tmpVipType.setCanVisitEnemyPlanets(true);
        tmpVipType.setAssassination(80);
        tmpVipType.setFrequency(BlackMarketFrequency.UNCOMMON);
        gw.addVipType(tmpVipType);
        
        tmpVipType = new VIPType("Master Engineer","Tech",neutral);
        tmpVipType.setShowOnOpenPlanet(true);
        ...
        tmpVipType = new VIPType("Master Diplomat","Dip",neutral);
        tmpVipType.setFrequency(BlackMarketFrequency.RARE);
        tmpVipType.setCanVisitNeutralPlanets(true);
        tmpVipType.setDiplomat(true);
        tmpVipType.setSpying(true);
        ...
        tmpVipType = new VIPType("White Psi Apprentice","WPA",good);
        tmpVipType.setCanVisitEnemyPlanets(true);
        tmpVipType.setDuellistSkill(VIPType.DUELLIST_APPRENTICE);
        ...
        tmpVipType = new VIPType("White Psi Master","WPM",good);
        tmpVipType.setCanVisitEnemyPlanets(true);
        ...
        tmpVipType = new VIPType("Gray Psi Apprentice","GPA",neutral);
        tmpVipType.setCanVisitEnemyPlanets(true);
        tmpVipType.setHardToKill(true);
        tmpVipType.setImmuneToCounterEspionage(true);
        tmpVipType.setFrequency(BlackMarketFrequency.RARE);
        ...
        tmpVipType = new VIPType("Gray Psi Master","GPM",neutral);
        tmpVipType.setCanVisitEnemyPlanets(true);
        tmpVipType.setHardToKill(true);
        tmpVipType.setImmuneToCounterEspionage(true);
        tmpVipType.setFrequency(BlackMarketFrequency.UNCOMMON);
        ...
        tmpVipType = new VIPType("Black Psi Apprentice","BPA",evil);
        tmpVipType.setCanVisitEnemyPlanets(true);
        tmpVipType.setDuellistSkill(VIPType.DUELLIST_APPRENTICE);
        tmpVipType.setInitFighterSquadronBonus(5);
        tmpVipType.setHardToKill(true);
        ...
        tmpVipType = new VIPType("Black Psi Master","BPM",evil);
        tmpVipType.setCanVisitEnemyPlanets(true);
        tmpVipType.setDuellistSkill(VIPType.DUELLIST_VETERAN);
        tmpVipType.setPsychWarfareBonus(1);
        tmpVipType.setInitFighterSquadronBonus(10);
        ...
        // rainbow psi master
        tmpVipType = new VIPType("Psi Grand Master","PGM",neutral);
        tmpVipType.setCanVisitEnemyPlanets(true);
        tmpVipType.setHardToKill(true);
        tmpVipType.setImmuneToCounterEspionage(true);
        tmpVipType.setFrequency(BlackMarketFrequency.RARE);
        ...
        // Klackon vips
        tmpVipType = new VIPType("Klackon Breeder","KBre",klackon);
        tmpVipType.setResistanceBonus(3);
        tmpVipType.setShipBuildBonus(30);
        tmpVipType.setBuildingBuildBonus(30);
        gw.addVipType(tmpVipType);

        tmpVipType = new VIPType("Klackon Admiral","KAdm",klackon);
        tmpVipType.setInitBonus(10);
        tmpVipType.setBombardmentBonus(1);
        gw.addVipType(tmpVipType);

        tmpVipType = new VIPType("Klackon Assassin","KAss",klackon);
        tmpVipType.setCanVisitEnemyPlanets(true);
        tmpVipType.setAssassination(60);
        gw.addVipType(tmpVipType);
        
        tmpVipType = new VIPType("Klackon Infestator","KInf",klackon);
        tmpVipType.setCanVisitEnemyPlanets(true);
        tmpVipType.setInfestate(true);
        gw.addVipType(tmpVipType);
                
        // Bug vips
        tmpVipType = new VIPType("Brain Bug","BGen",arachnid);
        tmpVipType.setResistanceBonus(2);
        tmpVipType.setCounterEspionage(50);
        tmpVipType.setClosedIncBonus(2);
        gw.addVipType(tmpVipType);

        tmpVipType = new VIPType("Psi Bug","BPsi",arachnid);
        tmpVipType.setInitBonus(10);
        tmpVipType.setFTLbonus(true);
        tmpVipType.setPlanetarySurvey(true);
        gw.addVipType(tmpVipType);

        tmpVipType = new VIPType("Bug Ace","BAce",arachnid);
        tmpVipType.setInitFighterSquadronBonus(10);
        tmpVipType.setSpying(true);
        gw.addVipType(tmpVipType);

        tmpVipType = new VIPType("Bug Princess","BPri",arachnid);
        tmpVipType.setCanVisitNeutralPlanets(true);
        tmpVipType.setInfestate(true);
        tmpVipType.setSpying(true);
        gw.addVipType(tmpVipType);
		...
		tempsst = new SpaceshipType("IP Patrol Boat","IPPB",SpaceShipSize.SMALL,10,30,SpaceshipRange.NONE,1,3, 15,10);
        ...
        tempsst = new SpaceshipType("IP Corvette","IPCo",SpaceShipSize.MEDIUM,30,100,SpaceshipRange.NONE,1,6, 30,10);
        ...
        tempsst = new SpaceshipType("IP Cruiser","IPCr",SpaceShipSize.LARGE,80,300,SpaceshipRange.NONE,2,9, 50,10);
        ...
        // Blockade Runner
        tempsst = new SpaceshipType("Blockade Runner","Run", SpaceShipSize.SMALL,SpaceshipRange.LONG,1,5);
        ...
        tempsst = new SpaceshipType("Small Merchant Freighter","SMF",SpaceShipSize.SMALL,SpaceshipRange.LONG,1,4);
        ...
        */
        ...
        // Survey ship
        tempsst = new SpaceshipType("Outreach Survey Ship","Out",SpaceShipSize.SMALL,SpaceshipRange.LONG,1,8);
        ...
        tempsst = new SpaceshipType("Medium Merchant Freighter","MMF",SpaceShipSize.MEDIUM,SpaceshipRange.LONG,1,8);
        ...
        // Supply Freighter
        tempsst = new SpaceshipType("Supply Ship","Sup",SpaceShipSize.MEDIUM,SpaceshipRange.LONG,1,8);
        ...
        tempsst = new SpaceshipType("Large Merchant Freighter","LMF",SpaceShipSize.LARGE,SpaceshipRange.SHORT,1,12);
        ...
        tempsst = new SpaceshipType("Mobile Resupply Base","MRB",SpaceShipSize.HUGE,SpaceshipRange.SHORT,3,15);
        ...
        // VIP transport
        tempsst = new SpaceshipType("VIP Transport","VT",SpaceShipSize.SMALL,SpaceshipRange.LONG,1,3);
...
//        tempsst.setPlayerUnique(true); // ev. l�gga tillbaka detta d� buggen i minishipplanet �r fixad
        ...
        // Scout
        tempsst = new SpaceshipType("Nike FTL Scout","Sct",SpaceShipSize.SMALL,5,10,SpaceshipRange.LONG,1,2, 5,5);
		...
		// Patrol Boat
		tempsst = new SpaceshipType("Patrol Boat","Pat",SpaceShipSize.SMALL,10,40,SpaceshipRange.LONG,2,5, 10,10);
        ...
        // Patrol Corvette
		tempsst = new SpaceshipType("Patrol Corvette","PCrv",SpaceShipSize.SMALL,20,60,SpaceshipRange.LONG,3,8, 25,15);
		...
		tempsst = new SpaceshipType("Troop Armed Transport","TrAT",SpaceShipSize.MEDIUM,10,30,SpaceshipRange.LONG,2,10, 5,5);
        ...
        // Corvette
		tempsst = new SpaceshipType("Corvette","Crv",SpaceShipSize.MEDIUM,30,100,SpaceshipRange.LONG,4,10, 40,15);
		...
		List<BuildingType> tempBuildings;
		BuildingType tmpBuildingType ;
		...
		tempsst = new SpaceshipType(typeName,"UDes",SpaceShipSize.MEDIUM,50,160,SpaceshipRange.LONG,5,14, 35,10);
		...
		tempsst = new SpaceshipType(typeName,"ULCa",SpaceShipSize.MEDIUM,60,220,SpaceshipRange.LONG,6,18, 10,15);
		...
		tempsst = new SpaceshipType(typeName,"ULCr",SpaceShipSize.LARGE,80,320,SpaceshipRange.SHORT,8,26, 50,15);
		...
		SpaceshipMutator.setArmor(tempsst, 50,35);
        tempsst.setTargetingType(SpaceshipTargetingType.ANTIMBU);
        tempsst.setWeaponsStrengthMedium(120);
        gw.addShipType(tempsst);
        tempFaction.addSpaceshipType(gw.getSpaceshipTypeByName(typeName));
		...
		tempsst = new SpaceshipType(typeName,"UCr",SpaceShipSize.LARGE,140,420,SpaceshipRange.SHORT,10,32, 40,10);
		...
		tempsst = new SpaceshipType(typeName,"UCa",SpaceShipSize.LARGE,160,470,SpaceshipRange.SHORT,8,28, 20,20);
		...
		tempsst = new SpaceshipType(typeName,"UBCr",SpaceShipSize.LARGE,150,550,SpaceshipRange.SHORT,12,40, 40,10);
		...
		SpaceshipMutator.setArmor(tempsst, 70,45);
        tempsst.setTargetingType(SpaceshipTargetingType.ANTIMBU);
        tempsst.setWeaponsStrengthMedium(170);
		...
		tempsst = new SpaceshipType(typeName,"UBSs",SpaceShipSize.HUGE,250,850,SpaceshipRange.SHORT,23,70, 50,15);
		...
		tempsst = new SpaceshipType(typeName,"UBS",SpaceShipSize.HUGE,400,1300,SpaceshipRange.SHORT,30,100, 60,20);
        ...
        // Governor
        tmpVipType = new VIPType("UTF Governor","Gov",good);
        tmpVipType.setCanVisitNeutralPlanets(true);
        tmpVipType.setDiplomat(true);
...
//        tempBuildings.add(tmpBuildingType);        
		...
		tempsst = new SpaceshipType(typeName,"ADes",SpaceShipSize.MEDIUM,50,150,SpaceshipRange.LONG,5,15, 30,10);
		tempsst.setDescription("Medium-sized long range military ship. It is most useful when attacking small or medium opponents or as support against less powerful large ships. It is too weak to do any significant damage against huge opponents.");
		SpaceshipMutator.setArmor(tempsst, 40);
        tempsst.setTargetingType(SpaceshipTargetingType.ANTIMBU);
        tempsst.setWeaponsStrengthMedium(40);        
		...
		tempsst = new SpaceshipType(typeName,"ALCa",SpaceShipSize.MEDIUM,60,200,SpaceshipRange.LONG,6,18, 10,15);
		tempsst.setDescription("Medium-sized long range squadron carrier. Can carry up to 4 squadrons.");
		SpaceshipMutator.setArmor(tempsst, 20);
        tempsst.setTargetingType(SpaceshipTargetingType.ALLROUND);
        tempsst.setSquadronCapacity(4);
		...
		tempsst = new SpaceshipType(typeName,"ALCr",SpaceShipSize.LARGE,80,300,SpaceshipRange.SHORT,8,28, 50,15);
		...
		tempsst = new SpaceshipType(typeName,"ACr",SpaceShipSize.LARGE,130,400,SpaceshipRange.SHORT,10,30, 40,10);
		tempsst.setDescription("Large-sized short-range capital ship. It is very good against small or medium opponents and pretty good against large ones. It is too weak to to do very much damage to huge opponents. It has troops, bombardment and can carry one squadron.");
		SpaceshipMutator.setArmor(tempsst, 60,40);
        tempsst.setTargetingType(SpaceshipTargetingType.ANTIMBU);
        tempsst.setWeaponsStrengthMedium(150);
		...
		tempsst = new SpaceshipType(typeName,"ACa",SpaceShipSize.LARGE,140,450,SpaceshipRange.SHORT,8,26, 15,20);
		tempsst.setDescription("Large-sized short range squadron carrier. Can carry up to 8 squadrons.");
		SpaceshipMutator.setArmor(tempsst, 40,20);
        tempsst.setTargetingType(SpaceshipTargetingType.ALLROUND);
        tempsst.setSquadronCapacity(8);
		...
		tempsst = new SpaceshipType(typeName,"ABCr",SpaceShipSize.LARGE,140,500,SpaceshipRange.SHORT,12,36, 40,10);
		...
		tempsst = new SpaceshipType(typeName,"ABSs",SpaceShipSize.HUGE,220,800,SpaceshipRange.SHORT,22,65, 50,15);
		...
		tempsst = new SpaceshipType(typeName,"ABS",SpaceShipSize.HUGE,350,1150,SpaceshipRange.SHORT,28,90, 60,20);
        ...
        tmpVipType = new VIPType("Azuriach Governor","Gov",evil);
        tmpVipType.setCanVisitNeutralPlanets(true);
        tmpVipType.setDiplomat(true);
        tmpVipType.setGovernor(true);
        tmpVipType.setWellGuarded(true);
...
//        tempBuildings.add(tmpBuildingType);        
        ...
        tempsst = new SpaceshipType(typeName,"HMF",SpaceShipSize.HUGE,SpaceshipRange.SHORT,1,16);
		...
		tempsst = new SpaceshipType(typeName,"SQS",SpaceShipSize.SMALL,20,70,SpaceshipRange.LONG,3,10, 30,5);
		...
		tempsst = new SpaceshipType(typeName,"MQS",SpaceShipSize.MEDIUM,30,130,SpaceshipRange.LONG,5,15, 20,5);
		...
		tempsst = new SpaceshipType(typeName,"IDes",SpaceShipSize.MEDIUM,50,150,SpaceshipRange.LONG,5,15, 35,10);
		tempsst.setDescription("Medium-sized long range military ship. It is most useful when attacking small or medium opponents or as support against less powerful large ships. It is too weak to do any significant damage against huge opponents.");
		SpaceshipMutator.setArmor(tempsst, 40);
        tempsst.setTargetingType(SpaceshipTargetingType.ANTIMBU);
		...
		tempsst = new SpaceshipType(typeName,"ILCa",SpaceShipSize.MEDIUM,50,180,SpaceshipRange.LONG,6,18, 10,15);
		tempsst.setDescription("Medium-sized long range squadron carrier. Can carry up to 4 squadrons.");
		...
		tempsst = new SpaceshipType(typeName,"ICr",SpaceShipSize.LARGE,120,380,SpaceshipRange.SHORT,9,28, 40,10);
		tempsst.setDescription("Large-sized short-range capital ship. It is very good against small or medium opponents and pretty good against large ones. It is too weak to to do very much damage to huge opponents. It has troops, bombardment and can carry one squadron.");
		SpaceshipMutator.setArmor(tempsst, 60,40);
        tempsst.setTargetingType(SpaceshipTargetingType.ANTIMBU);
		...
		tempsst = new SpaceshipType(typeName,"ICa",SpaceShipSize.LARGE,100,350,SpaceshipRange.SHORT,7,22, 10,20);
		...
		tempsst = new SpaceshipType(typeName,"IBSs",SpaceShipSize.HUGE,200,650,SpaceshipRange.SHORT,18,55, 40,15);
		tempsst.setDescription("Huge-sized short range capital ship. Has a powerful array of weapons that make significant damage to ships of all sizes, and have powerful armor. It has troops, bombardment and can carry three squadrons. It also have a tactical center to increase combat effectiveness.");
		SpaceshipMutator.setArmor(tempsst, 80,60,40);
        tempsst.setTargetingType(SpaceshipTargetingType.ANTIMBU);
        tempsst.setWeaponsStrengthMedium(100);
		...
		tempsst = new SpaceshipType(typeName,"IBS",SpaceShipSize.HUGE,280,950,SpaceshipRange.SHORT,22,70, 60,20);
        ...
        tmpVipType = new VIPType("IRSOL Governor","Gov",neutral);
        tmpVipType.setCanVisitNeutralPlanets(true);
        tmpVipType.setDiplomat(true);
        tmpVipType.setGovernor(true);
        tmpVipType.setWellGuarded(true);
...
//        tempBuildings.add(tmpBuildingType);        
		...
		tempsst = new SpaceshipType(typeName,"TPCo",SpaceShipSize.SMALL,60,60,SpaceshipRange.LONG,3,10, 40,15);
		...
		tempsst = new SpaceshipType(typeName,"TDes",SpaceShipSize.MEDIUM,180,180,SpaceshipRange.LONG,5,20, 50,20);
		...
		tempsst = new SpaceshipType(typeName,"TCom",SpaceShipSize.MEDIUM,10,180,SpaceshipRange.LONG,5,20, 5,5);
		...
		tempsst = new SpaceshipType(typeName,"TSie",SpaceShipSize.MEDIUM,10,180,SpaceshipRange.LONG,5,20, 5,5);
		...
		tempsst = new SpaceshipType(typeName,"TCa",SpaceShipSize.MEDIUM,10,180,SpaceshipRange.LONG,5,16, 5,5);
		...
		tempsst = new SpaceshipType(typeName,"TFCr",SpaceShipSize.LARGE,550,550,SpaceshipRange.SHORT,12,50, 50,15);
        ...
        tmpVipType = new VIPType("Transhuman Governor","Gov",neutral);
        tmpVipType.setCanVisitNeutralPlanets(true);
        tmpVipType.setDiplomat(true);
        tmpVipType.setGovernor(true);
        tmpVipType.setWellGuarded(true);
...
//        tempBuildings.add(tmpBuildingType);        
        ...
        addGeneralShipTypesAndStartingTypes(tempFaction,gw,true,false);
		...
		tempsst = new SpaceshipType(typeName,"MDes",SpaceShipSize.MEDIUM,75,150,SpaceshipRange.LONG,5,18, 40,40);
		...
		tempsst = new SpaceshipType(typeName,"MCr",SpaceShipSize.LARGE,150,300,SpaceshipRange.LONG,9,28, 40,30);
		...
		tempsst = new SpaceshipType(typeName,"MBSs",SpaceShipSize.HUGE,300,600,SpaceshipRange.LONG,20,60, 40,15);
        ...
        tmpVipType = new VIPType("MekPurr Governor","Gov",good);
        tmpVipType.setCanVisitNeutralPlanets(true);
        tmpVipType.setDiplomat(true);
        tmpVipType.setGovernor(true);
        tmpVipType.setWellGuarded(true);
...
//        tempBuildings.add(tmpBuildingType);        
		...
		tempsst = new SpaceshipType(typeName,"BTrT",SpaceShipSize.MEDIUM,10,40,SpaceshipRange.LONG,3,12, 10,5);
		...
		tempsst = new SpaceshipType(typeName,"BDes",SpaceShipSize.MEDIUM,80,250,SpaceshipRange.LONG,5,20, 40,15);
		...
		SpaceshipMutator.setArmor(tempsst, 50);
        tempsst.setTargetingType(SpaceshipTargetingType.ANTIMBU);
		...
		tempsst = new SpaceshipType(typeName,"BCa",SpaceShipSize.MEDIUM,70,280,SpaceshipRange.LONG,6,20, 10,15);
		...
		tempsst = new SpaceshipType(typeName,"BCr",SpaceShipSize.LARGE,150,550,SpaceshipRange.SHORT,12,36, 40,10);
		...
		SpaceshipMutator.setArmor(tempsst, 75,50);
        tempsst.setTargetingType(SpaceshipTargetingType.ANTIMBU);
		...
		tempsst = new SpaceshipType(typeName,"BBSs",SpaceShipSize.HUGE,280,900,SpaceshipRange.SHORT,22,70, 50,15);
		...
		SpaceshipMutator.setArmor(tempsst, 85,65,45);
        tempsst.setTargetingType(SpaceshipTargetingType.ANTIMBU);
        tempsst.setWeaponsStrengthMedium(150);
        ...
        tmpVipType = new VIPType("Blarad Governor","Gov",good);
        tmpVipType.setCanVisitNeutralPlanets(true);
        tmpVipType.setDiplomat(true);
        tmpVipType.setGovernor(true);
        tmpVipType.setWellGuarded(true);
...
//        tempBuildings.add(tmpBuildingType);        
        ...
        addGeneralShipTypesAndStartingTypes(tempFaction,gw,false,true);
        tempFaction.setGovernorVIPType(govType);
        tempFaction.setCanReconstruct(true);
        tempFaction.setReconstructCostBase(9);
		...
		tempsst = new SpaceshipType(typeName,"HDes",SpaceShipSize.MEDIUM,50,150,SpaceshipRange.LONG,5,15, 30,10);
		tempsst.setDescription("Medium sized long range military ship. It is most useful when attacking small or medium opponents or as support against less powerful large ships. It is too weak to do any significant damage against huge opponents.");
		SpaceshipMutator.setArmor(tempsst, 40);
        tempsst.setTargetingType(SpaceshipTargetingType.ANTIMBU);
        tempsst.setWeaponsStrengthMedium(40);        
		...
		tempsst = new SpaceshipType(typeName,"HLCa",SpaceShipSize.MEDIUM,70,250,SpaceshipRange.LONG,5,20, 10,15);
		tempsst.setDescription("Medium-sized long range squadron carrier. Can carry up to 6 squadrons.");
		SpaceshipMutator.setArmor(tempsst, 20);
        tempsst.setTargetingType(SpaceshipTargetingType.ALLROUND);
        tempsst.setSquadronCapacity(6);
		...
		tempsst = new SpaceshipType(typeName,"HLCr",SpaceShipSize.LARGE,80,300,SpaceshipRange.SHORT,8,24, 40,15);
		tempsst.setDescription("Large-sized short-range capital ship. It is very good against small or medium opponents and pretty good against large ones. It is too weak to to do very much damage to huge opponents. It has troops, bombardment and can carry one squadron.");
		SpaceshipMutator.setArmor(tempsst, 45,30);
        tempsst.setTargetingType(SpaceshipTargetingType.ANTIMBU);
        tempsst.setWeaponsStrengthMedium(100);
        tempsst.setBombardment(1);
        tempsst.setPsychWarfare(1);
		...
		tempsst = new SpaceshipType(typeName,"HCa",SpaceShipSize.LARGE,150,500,SpaceshipRange.SHORT,7,26, 10,20);
		tempsst.setDescription("Large-sized short range squadron carrier. Can carry up to 12 squadrons.");
		SpaceshipMutator.setArmor(tempsst, 30,10);
        tempsst.setTargetingType(SpaceshipTargetingType.ALLROUND);
		...
		tempsst = new SpaceshipType(typeName,"HBSs",SpaceShipSize.HUGE,200,700,SpaceshipRange.SHORT,20,60, 50,15);
		tempsst.setDescription("Huge-sized short range capital ship. Has a powerful array of weapons that make significant damage to ships of all sizes, and have powerful armor. It has troops, bombardment and can carry three squadrons. It also have a tactical center to increase combat effectiveness.");
		SpaceshipMutator.setArmor(tempsst, 80,60,40);
        tempsst.setTargetingType(SpaceshipTargetingType.ANTIMBU);
        tempsst.setWeaponsStrengthMedium(120);
        ...
        tmpVipType = new VIPType("Hiss'ist Leader","Gov",neutral);
        tmpVipType.setCanVisitNeutralPlanets(true);
        tmpVipType.setDiplomat(true);
        tmpVipType.setGovernor(true);
        tmpVipType.setWellGuarded(true);
...
//        tempBuildings.add(tmpBuildingType);        
		...
		tempsst = new SpaceshipType(typeName,"RCrv",SpaceShipSize.MEDIUM,30,130,SpaceshipRange.LONG,5,10, 30,15);
		...
		tempsst = new SpaceshipType(typeName,"RDes",SpaceShipSize.MEDIUM,50,200,SpaceshipRange.LONG,6,14, 30,10);
		...
		tempsst = new SpaceshipType(typeName,"RSC",SpaceShipSize.MEDIUM,40,200,SpaceshipRange.LONG,6,14, 10,10);
		...
		tempsst = new SpaceshipType(typeName,"RLCr",SpaceShipSize.LARGE,70,280,SpaceshipRange.LONG,9,22, 40,10);
		...
		SpaceshipMutator.setArmor(tempsst, 40,25);
        tempsst.setTargetingType(SpaceshipTargetingType.ANTIMBU);
        tempsst.setWeaponsStrengthMedium(80);
		...
		tempsst = new SpaceshipType(typeName,"RBCr",SpaceShipSize.LARGE,120,450,SpaceshipRange.SHORT,12,28, 30,10);
        ...
        tmpVipType = new VIPType("Ranan Leader","Gov",neutral);
        tmpVipType.setCanVisitNeutralPlanets(true);
        tmpVipType.setDiplomat(true);
        tmpVipType.setGovernor(true);
        tmpVipType.setWellGuarded(true);
...
//        tempBuildings.add(tmpBuildingType);        
		...
		tempsst = new SpaceshipType(typeName,"KGas",SpaceShipSize.SMALL,0,kLDC,SpaceshipRange.LONG,2,kLBuy+2, 2,2);
		...
		tempsst = new SpaceshipType(typeName,"KCol",SpaceShipSize.SMALL,0,kLDC,SpaceshipRange.LONG,2,kLBuy+4, 2,2);
		...
		tempsst = new SpaceshipType(typeName,"KSup",SpaceShipSize.SMALL,0,kLDC,SpaceshipRange.LONG,2,kLBuy+4, 2,2);
		...
		tempsst = new SpaceshipType(typeName,"KSH",SpaceShipSize.SMALL,10,kLDC,SpaceshipRange.LONG,2,kLBuy, 15,30);
		...
		tempsst = new SpaceshipType(typeName,"KLB",SpaceShipSize.SMALL,10,kLDC,SpaceshipRange.LONG,2,kLBuy, 40,10);
		...
		tempsst = new SpaceshipType(typeName,"KLMB",SpaceShipSize.SMALL,10,kLDC,SpaceshipRange.LONG,2,kLBuy, 5,5);
		...
		tempsst = new SpaceshipType(typeName,"KLTB",SpaceShipSize.SMALL,10,kLDC,SpaceshipRange.LONG,2,kLBuy, 5,5);
		...
		tempsst = new SpaceshipType(typeName,"KLSB",SpaceShipSize.SMALL,10,kLDC,SpaceshipRange.LONG,2,kLBuy, 5,5);
		...
		tempsst = new SpaceshipType(typeName,"KHMB",SpaceShipSize.MEDIUM,20,kHDC,SpaceshipRange.SHORT,3,kHBuy, 40,10);
		...
		tempsst = new SpaceshipType(typeName,"KHTB",SpaceShipSize.MEDIUM,20,kHDC,SpaceshipRange.SHORT,3,kHBuy, 40,10);
		...
		tempsst = new SpaceshipType(typeName,"KHSB",SpaceShipSize.MEDIUM,20,kHDC,SpaceshipRange.SHORT,3,kHBuy, 40,10);
		...
		tempsst = new SpaceshipType(typeName,"KMS",SpaceShipSize.MEDIUM,0,kHDC,SpaceshipRange.SHORT,5,20, 5,5);
        ...
        tmpVipType = new VIPType("Klackon Leader","KL",klackon);
        tmpVipType.setGovernor(true);
        tmpVipType.setWellGuarded(true);
        tmpVipType.setResistanceBonus(2);
        tmpVipType.setInfestate(true);
...
//        tempBuildings.add(tmpBuildingType);        
        ...
        setWharfs(tempBuildings, "Klackon","K",5,10);
		...
		tempsst = new SpaceshipType(typeName,"BDM",SpaceShipSize.SMALL,0,200,SpaceshipRange.NONE,1,6, 10,10);
		...
		tempsst = new SpaceshipType(typeName,"BSM",SpaceShipSize.SMALL,0,500,SpaceshipRange.LONG,5,10, 10,10);
		...
		tempsst = new SpaceshipType(typeName,"BMM",SpaceShipSize.MEDIUM,0,1000,SpaceshipRange.LONG,10,20, 15,15);
		...
		tempsst = new SpaceshipType(typeName,"BLM",SpaceShipSize.LARGE,0,2000,SpaceshipRange.SHORT,14,40, 15,15);
		...
		tempsst = new SpaceshipType(typeName,"BHM",SpaceShipSize.HUGE,0,5000,SpaceshipRange.SHORT,20,80, 15,15);
        ...
        tmpVipType = new VIPType("Bug Queen","BQ",arachnid);
        tmpVipType.setGovernor(true);
        tmpVipType.setWellGuarded(true);
        tmpVipType.setResistanceBonus(2);
        tmpVipType.setFTLbonus(true);
...
//        tempBuildings.add(tmpBuildingType);        
        ...
        // Bugs relation
        tempDiplomacyRelation = GameWorldCreator.getRelation(bugsFaction, bugsFaction, gw);
        ...
        tempDiplomacyRelation = GameWorldCreator.getRelation(bugsFaction, utfFaction, gw);
        tempDiplomacyRelation.setHighestRelation(DiplomacyLevel.ETERNAL_WAR);
        tempDiplomacyRelation.setStartRelation(DiplomacyLevel.ETERNAL_WAR);

        tempDiplomacyRelation = GameWorldCreator.getRelation(bugsFaction, azuriachFaction, gw);
        tempDiplomacyRelation.setHighestRelation(DiplomacyLevel.ETERNAL_WAR);
        tempDiplomacyRelation.setStartRelation(DiplomacyLevel.ETERNAL_WAR);

        tempDiplomacyRelation = GameWorldCreator.getRelation(bugsFaction, irsolFaction, gw);
        tempDiplomacyRelation.setHighestRelation(DiplomacyLevel.ETERNAL_WAR);
        tempDiplomacyRelation.setStartRelation(DiplomacyLevel.ETERNAL_WAR);

        tempDiplomacyRelation = GameWorldCreator.getRelation(bugsFaction, transhumanFaction, gw);
        tempDiplomacyRelation.setHighestRelation(DiplomacyLevel.ETERNAL_WAR);
        tempDiplomacyRelation.setStartRelation(DiplomacyLevel.ETERNAL_WAR);

        tempDiplomacyRelation = GameWorldCreator.getRelation(bugsFaction, blaradFaction, gw);
        tempDiplomacyRelation.setHighestRelation(DiplomacyLevel.ETERNAL_WAR);
        tempDiplomacyRelation.setStartRelation(DiplomacyLevel.ETERNAL_WAR);

        tempDiplomacyRelation = GameWorldCreator.getRelation(bugsFaction, mekpurrFaction, gw);
        tempDiplomacyRelation.setHighestRelation(DiplomacyLevel.ETERNAL_WAR);
        tempDiplomacyRelation.setStartRelation(DiplomacyLevel.ETERNAL_WAR);
...
//        tempDiplomacyRelation.setStartRelation(DiplomacyLevel.ETERNAL_WAR);
        ...
        tempDiplomacyRelation = GameWorldCreator.getRelation(bugsFaction, hissistFaction, gw);
        tempDiplomacyRelation.setHighestRelation(DiplomacyLevel.ETERNAL_WAR);
        tempDiplomacyRelation.setStartRelation(DiplomacyLevel.ETERNAL_WAR);

        tempDiplomacyRelation = GameWorldCreator.getRelation(bugsFaction, rananFaction, gw);
        tempDiplomacyRelation.setHighestRelation(DiplomacyLevel.ETERNAL_WAR);
        tempDiplomacyRelation.setStartRelation(DiplomacyLevel.ETERNAL_WAR);

        tempDiplomacyRelation = GameWorldCreator.getRelation(bugsFaction, klackonFaction, gw);
        tempDiplomacyRelation.setHighestRelation(DiplomacyLevel.ETERNAL_WAR);
        tempDiplomacyRelation.setStartRelation(DiplomacyLevel.ETERNAL_WAR);

        // Klackon relations
        
        tempDiplomacyRelation = GameWorldCreator.getRelation(klackonFaction, utfFaction, gw);
        tempDiplomacyRelation.setHighestRelation(DiplomacyLevel.ETERNAL_WAR);
        tempDiplomacyRelation.setStartRelation(DiplomacyLevel.ETERNAL_WAR);

        tempDiplomacyRelation = GameWorldCreator.getRelation(klackonFaction, azuriachFaction, gw);
        tempDiplomacyRelation.setHighestRelation(DiplomacyLevel.ETERNAL_WAR);
        tempDiplomacyRelation.setStartRelation(DiplomacyLevel.ETERNAL_WAR);

        tempDiplomacyRelation = GameWorldCreator.getRelation(klackonFaction, irsolFaction, gw);
        tempDiplomacyRelation.setHighestRelation(DiplomacyLevel.ETERNAL_WAR);
        tempDiplomacyRelation.setStartRelation(DiplomacyLevel.ETERNAL_WAR);

        tempDiplomacyRelation = GameWorldCreator.getRelation(klackonFaction, transhumanFaction, gw);
        tempDiplomacyRelation.setHighestRelation(DiplomacyLevel.ETERNAL_WAR);
        tempDiplomacyRelation.setStartRelation(DiplomacyLevel.ETERNAL_WAR);

        tempDiplomacyRelation = GameWorldCreator.getRelation(klackonFaction, blaradFaction, gw);
        tempDiplomacyRelation.setHighestRelation(DiplomacyLevel.ETERNAL_WAR);
        tempDiplomacyRelation.setStartRelation(DiplomacyLevel.ETERNAL_WAR);

        tempDiplomacyRelation = GameWorldCreator.getRelation(klackonFaction, mekpurrFaction, gw);
        tempDiplomacyRelation.setHighestRelation(DiplomacyLevel.ETERNAL_WAR);
        tempDiplomacyRelation.setStartRelation(DiplomacyLevel.ETERNAL_WAR);
...
//        tempDiplomacyRelation.setStartRelation(DiplomacyLevel.ETERNAL_WAR);
        ...
        tempDiplomacyRelation = GameWorldCreator.getRelation(klackonFaction, hissistFaction, gw);
        tempDiplomacyRelation.setHighestRelation(DiplomacyLevel.ETERNAL_WAR);
        tempDiplomacyRelation.setStartRelation(DiplomacyLevel.ETERNAL_WAR);

        tempDiplomacyRelation = GameWorldCreator.getRelation(klackonFaction, rananFaction, gw);
        tempDiplomacyRelation.setHighestRelation(DiplomacyLevel.ETERNAL_WAR);
        tempDiplomacyRelation.setStartRelation(DiplomacyLevel.ETERNAL_WAR);
        
        // Utf relations
        
        tempDiplomacyRelation = GameWorldCreator.getRelation(utfFaction, azuriachFaction, gw);
        tempDiplomacyRelation.setHighestRelation(DiplomacyLevel.CEASE_FIRE);

        tempDiplomacyRelation = GameWorldCreator.getRelation(utfFaction, rananFaction, gw);
        tempDiplomacyRelation.setHighestRelation(DiplomacyLevel.PEACE);

        tempDiplomacyRelation = GameWorldCreator.getRelation(utfFaction, hissistFaction, gw);
        tempDiplomacyRelation.setHighestRelation(DiplomacyLevel.PEACE);

        // Blarad relations
        
        tempDiplomacyRelation = GameWorldCreator.getRelation(blaradFaction, azuriachFaction, gw);
        tempDiplomacyRelation.setHighestRelation(DiplomacyLevel.PEACE);

        tempDiplomacyRelation = GameWorldCreator.getRelation(blaradFaction, rananFaction, gw);
        tempDiplomacyRelation.setHighestRelation(DiplomacyLevel.PEACE);

        tempDiplomacyRelation = GameWorldCreator.getRelation(blaradFaction, hissistFaction, gw);
        tempDiplomacyRelation.setHighestRelation(DiplomacyLevel.PEACE);

        // Mekpurr relations
        
        tempDiplomacyRelation = GameWorldCreator.getRelation(mekpurrFaction, azuriachFaction, gw);
        tempDiplomacyRelation.setHighestRelation(DiplomacyLevel.PEACE);

        tempDiplomacyRelation = GameWorldCreator.getRelation(mekpurrFaction, rananFaction, gw);
        tempDiplomacyRelation.setHighestRelation(DiplomacyLevel.CEASE_FIRE);

        tempDiplomacyRelation = GameWorldCreator.getRelation(mekpurrFaction, hissistFaction, gw);
        tempDiplomacyRelation.setHighestRelation(DiplomacyLevel.PEACE);
...
//        tempDiplomacyRelation.setHighestRelation(DiplomacyLevel.CEASE_FIRE);
        ...
        tempDiplomacyRelation = GameWorldCreator.getRelation(irsolFaction, rananFaction, gw);
        tempDiplomacyRelation.setHighestRelation(DiplomacyLevel.PEACE);
	...
	private static void addGeneralShipTypesAndStartingTypes(Faction tempFaction, GameWorld gw, boolean milTroops){
		addGeneralShipTypesAndStartingTypes(tempFaction,gw,milTroops,true);
	}
	
	private static void addGeneralShipTypesAndStartingTypes(Faction tempFaction, GameWorld gw, boolean milTroops, boolean hasCrv){
		// add shiptypes
		// -------------
		// defence ships
...
//        tempFaction.addStartingShipType(gw.getSpaceshipTypeByName("Blockade Runner"));
	...
	private static void setWharfs(List<BuildingType> aBuildings, String longPrefix, String shortPrefix, int... costs){
		setWharfs(aBuildings, longPrefix, shortPrefix, true, costs);
	}
	
	private static void setWharfs(List<BuildingType> aBuildings, String longPrefix, String shortPrefix, boolean visibleOnMap, int... costs){
		BuildingType tmpBuildingType;
	 ...
	 * 
	 */
	private static void setSpaceStations(List<BuildingType> aBuildings, String longPrefix, String shortPrefix, int openMod, int closedMod, int maxSize){
		BuildingType tmpBuildingType;
		BuildingType parent;
...
//			parent = tmpBuildingType;
	 ...
	 */
	private static void setKlackonMissileDefence(List<BuildingType> aBuildings){
		BuildingType parent = null;
		for (int i = 1; i < 6; i++){
		    BuildingType tmpBuildingType = new BuildingType("Klackon Missile Defence Mk " + i, "KMD-" + i, 5);
